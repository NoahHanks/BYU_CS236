...
void Rule :: addPredicate(Predicate pred){ predicateList.push_back(pred); }
Predicate Rule :: getHeadPredicate(){ return headPredicate; }
vector<Predicate> Rule :: getPredicateList(){ return predicateList; }
