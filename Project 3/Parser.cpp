...
vector<Token> Parser :: getTokenVector(){ return tokenVector; }
DatalogProgram Parser :: getData(){ return data; }
Predicate Parser :: getPredicate(){ return p; }
Rule Parser :: getRule(){ return r; }